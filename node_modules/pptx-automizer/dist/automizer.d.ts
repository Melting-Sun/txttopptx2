...
import { AutomizerParams, AutomizerSummary, ArchiveParams, SourceIdentifier, StatusTracker } from './types/types';
...
export default class Automizer implements IPresentationProps {
     ...
     * @returns Instance of Automizer
     */
    load(location: string, name?: string): this;
    /**
