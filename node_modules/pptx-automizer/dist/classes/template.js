...
class Template {
    constructor(location, params) {
        ...
        const archive = file_helper_1.FileHelper.importArchive(location, params);
        this.archive = archive;
    }
    static import(location, params, automizer) {
        let newTemplate;
        if (params.name) {
            // New template will be a default template containing
            // importable slides and shapes.
            newTemplate = new Template(location, params);
            ...
            newTemplate.content = new content_tracker_1.ContentTracker();
        }
        return newTemplate;
    }
