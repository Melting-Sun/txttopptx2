...
class HasShapes {
    ...
    getAllTextElementIds() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const slideXml = yield xml_helper_1.XmlHelper.getXmlFromArchive(template.archive, this.sourcePath);
                // Initialize the XmlSlideHelper
                const xmlSlideHelper = new xml_slide_helper_1.XmlSlideHelper(slideXml);
    ...
    removeElement(selector) {
        const presName = this.sourceTemplate.name;
        const slideNumber = this.sourceNumber;
        return this.addElementToModificationsList(presName, slideNumber, selector, 'remove', undefined);
    }
    /**
    ...
    getElementInfo(importElement) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const appendElementParams = yield this.analyzeElement(sourceElement, sourceArchive, slideNumber);
            return {
    ...
    analyzeElement(sourceElement, sourceArchive, slideNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isChart.length) {
                const target = yield xml_helper_1.XmlHelper.getTargetByRelId(sourceArchive, slideNumber, sourceElement, 'chart');
                return {
            ...
            if (isChartEx.length) {
                const target = yield xml_helper_1.XmlHelper.getTargetByRelId(sourceArchive, slideNumber, sourceElement, 'chartEx');
                return {
                    type: element_type_1.ElementType.Chart,
                    target: target,
                };
            ...
            if (isImage.length) {
                return {
                    ...
                    target: yield xml_helper_1.XmlHelper.getTargetByRelId(sourceArchive, slideNumber, sourceElement, 'image'),
                };
            }
            return {
