...
class Automizer {
    ...
    constructor(params) {
        ...
        if (params.rootTemplate) {
            ...
            this.rootTemplate = template_1.Template.import(location, this.archiveParams, this);
        }
        if (params.presTemplates) {
            this.params.presTemplates.forEach((file) => {
                const location = this.getLocation(file, 'template');
                const archiveParams = Object.assign(Object.assign({}, this.archiveParams), { name: file });
                const newTemplate = template_1.Template.import(location, archiveParams);
