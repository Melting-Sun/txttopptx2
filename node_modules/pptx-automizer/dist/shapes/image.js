...
class Image extends shape_1.Shape {
    ...
    append(targetTemplate, targetSlideNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.hasSvgRelation()) {
                const target = yield xml_helper_1.XmlHelper.getTargetByRelId(this.sourceArchive, this.sourceSlideNumber, this.targetElement, 'image:svg');
                yield new Image({
                    mode: 'append',
                    target,
    ...
    appendToSlideRels() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield xml_helper_1.XmlHelper.append(xml_helper_1.XmlHelper.createRelationshipChild(this.targetArchive, targetRelFile, attributes));
        });
    }
    hasSvgRelation() {
