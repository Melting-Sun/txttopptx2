...
export declare class XmlHelper {
    ...
    static appendIf(element: HelperElement): Promise<HelperElement | boolean>;
    static append(element: HelperElement): Promise<HelperElement>;
    ...
    static getTargetByRelId(archive: IArchive, slideNumber: number, element: XmlDocument, type: string): Promise<Target>;
    static findByElementCreationId(archive: IArchive, path: string, creationId: string): Promise<XmlDocument>;
    static findByElementName(archive: IArchive, path: string, name: string): Promise<XmlDocument>;
    ...
    static appendImageExtensionToContentType(targetArchive: IArchive, extension: string): Promise<HelperElement | boolean>;
