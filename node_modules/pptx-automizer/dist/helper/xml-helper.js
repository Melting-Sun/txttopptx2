...
const image_type_map_1 = require("../enums/image-type-map");
class XmlHelper {
    ...
    static getTargetByRelId(archive, slideNumber, element, type) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const imageRels = yield XmlHelper.getRelationshipTargetsByPrefix(archive, relsPath, params.prefix);
    ...
    static appendImageExtensionToContentType(targetArchive, extension) {
        const contentType = image_type_map_1.ImageTypeMap[extension]
            ? image_type_map_1.ImageTypeMap[extension]
            : 'image/' + extension;
    ...
    static sortCollection(collection, order, callback) {
        ...
        order.forEach((index, i) => {
            if (!collection[index]) {
                (0, general_helper_1.vd)('sortCollection index not found' + index);
                return;
            }
