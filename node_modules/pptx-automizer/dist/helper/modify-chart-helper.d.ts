...
import { ChartAxisRange, ChartData, ChartElementCoordinateShares } from '../types/chart-types';
...
export default class ModifyChartHelper {
     ...
     */
    static setChartData: (data: ChartData) => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
    /**
     * Set chart data to modify vertical line charts.
     * See `__tests__/modify-chart-vertical-lines.test.js`
     */
    static setChartVerticalLines: (data: ChartData) => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
    /**
     * Set chart data to modify scatter charts.
     * See `__tests__/modify-chart-scatter.test.js`
     */
    static setChartScatter: (data: ChartData) => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
    /**
     ...
     * See `__tests__/modify-chart-scatter.test.js`
     */
    static setChartCombo: (data: ChartData) => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
    /**
     * Set chart data to modify bubble charts.
     * See `__tests__/modify-chart-bubbles.test.js`
     */
    static setChartBubbles: (data: ChartData) => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
    /**
     * Set chart data to modify extended chart types.
     * See `__tests__/modify-existing-extended-chart.test.js`
     */
    static setExtendedChartData: (data: ChartData) => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
    static setAxisRange: (range: ChartAxisRange) => ShapeModificationCallback;
     ...
     * a user.
     */
    static minimizeChartLegend: () => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
    /**
     * Completely remove a chart legend. Please notice: This will trigger
     * PowerPoint to automatically maximize chart space.
     */
    static removeChartLegend: () => (element: XmlDocument | XmlElement, chart?: XmlDocument) => void;
    /**
     ...
     * @param legendArea
     */
    static setLegendPosition: (legendArea: ChartElementCoordinateShares) => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
    /**
     ...
     * @param plotArea
     */
    static setPlotArea: (plotArea: ChartElementCoordinateShares) => (element: XmlDocument | XmlElement, chart?: XmlDocument, workbook?: Workbook) => void;
}
